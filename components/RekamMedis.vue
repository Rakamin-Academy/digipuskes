  ...
  <div class="main-container">
        ...
        <div class="table-outer-container">
            ...
            <div class="table-header-container">
                ...
                <h4 class="table-header col5">Vaksin</h4>
            </div>
            <ul class="content-list isi-rekam">
                <li class="content-item">
                    <p class="list-item nama col1">Imunisasi BCG</p>
                    <p class="list-item spesialisasi col2">10/10/2020</p>
                    <p class="list-item jadwal-hari col3">09.00</p>
                    <p class="list-item waktu col4">Dr. James</p>
                    <p class="list-item waktu col5">BCS</p>
                    <div class="content-update">
                        <!-- Insert Icons -->
                        <i class="fas fa-pencil-alt edit-btn"></i>
                        <i class="far fa-check-square check-btn"></i>
                    </div>
                </li>
                <li class="content-item">
                    <p class="list-item nama col1">Imunisasi BCG</p>
        ...
        <div class="rencana-tindakan">
            ...
            <div class="tindakan-wrapper">
                ...
                <div class="tindakan-keterangan">
                    <h5>Keterangan</h5>
                    <textarea placeholder="beri keterangan..." rows="4" cols="50"></textarea>
                </div>
