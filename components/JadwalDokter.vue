        ...
        <div class="table-container">
            ...
            <ul class="content-list">
                <li class="content-item">
                    <p class="list-item nama col1">Dr. Jacob</p>
                    <p class="list-item spesialisasi col2">Dokter Umum</p>
                    <p class="list-item jadwal-hari col3">Senin - Rabu</p>
                    <p class="list-item waktu col4">09.00-11.30</p>
                </li>
                <li class="content-item">
                    <p class="list-item nama col1">Dr. Johns</p>
                    <p class="list-item spesialisasi col2">Dokter Spesialis Anak</p>
                    <p class="list-item jadwal-hari col3">Senin - Rabu</p>
                    <p class="list-item waktu col4">09.00-11.30</p>
                </li>
                <li class="content-item">
